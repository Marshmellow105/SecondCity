...
/obj/item/reagent_containers/blood/Initialize(mapload, vol)
	...
	reagents.add_reagent(bloodtype.reagent_type, start_blood_amount, blood_data, creation_callback = CALLBACK(src, PROC_REF(on_blood_created))) // DARKPACK EDIT CHANGE - (start_blood_amount)
